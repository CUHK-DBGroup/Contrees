...
const std::string CoreWorkload::FIELD_LENGTH_DISTRIBUTION_PROPERTY = "field_len_dist";
...
const std::string CoreWorkload::READMODIFYWRITE_PROPORTION_PROPERTY = "readmodifywriteproportion";
const std::string CoreWorkload::READMODIFYWRITE_PROPORTION_DEFAULT = "0.0";

const std::string CoreWorkload::REQUEST_DISTRIBUTION_PROPERTY = "requestdistribution";
const std::string CoreWorkload::REQUEST_DISTRIBUTION_DEFAULT = "uniform";

const std::string CoreWorkload::ZERO_PADDING_PROPERTY = "zeropadding";
const std::string CoreWorkload::ZERO_PADDING_DEFAULT = "1";
...
const std::string CoreWorkload::SCAN_LENGTH_DISTRIBUTION_PROPERTY = "scanlengthdistribution";
